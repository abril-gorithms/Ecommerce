...
<body>
        ...
        ?>
            ...
            <div class="box-wrap" ; style="width:100%; height:60px; background-color:#7aaf41; border:1; ">
                <h1 style="font-size: 50px; color:white; text-align: center; margin-top: 25px"><strong>PLANTS</strong></h1>
            </div>
            <br><br>
            <?php foreach ($products as $value) { ?>
                <a href="product.php?page=product&id=<?= $value['ProductID'] ?>">
                    <div class="box-wrap item" ; style="width:300px; height:300px; background-color:  rgb(187, 218, 187); border:1; margin-left: 100px; margin-bottom: 50px">
                        ...
                        <br><br>
                        <p style="font-size:20px; text-align: center; white-space:pre; color: black; width: 180px; margin-left: 50px;"><?php echo htmlspecialchars($value['Names']); ?></p> <br>
                        <p style="color:black;text-indent:20px; white-space:pre; background-color: #73a242; margin-left:45px; font-size:22px; width: 200px;"><?php echo "$ ", htmlspecialchars($value['Price']); ?></p>
                    </div>
                </a>
            <?php } ?>
